...
distilled from 2,467 runs (2,151 controlled). Under the protocol, no source
combination establishes a multiplicity-corrected gain over the tuned
price-only baseline — a reference null any future
