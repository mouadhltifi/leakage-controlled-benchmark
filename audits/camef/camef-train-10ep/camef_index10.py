import os
os.environ["CAMEF_SPLIT"] = "index"
#!/usr/bin/env python3
"""
CAMEF 10-epoch retrain on Kaggle T4 — ONE SPLIT per kernel, the DOCUMENTED ten-epoch budget.
...
DEVIATIONS FROM STOCK (env-necessary only; each documented at file:line below):
  ...
  D3'. epochs = 10 — the budget the CAMEF paper (App. C.2) and the README train example
       (README.md:209-219, --epochs 10) document. The code default is 5 (train.py:29); our
       audited 5-epoch runs used that default. This run uses the documented budget.
...
EPOCHS = "10"  # D3': documented budget (paper App. C.2 + README --epochs 10); code default is 5
